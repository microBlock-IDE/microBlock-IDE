Blockly.Python.forBlock['sled_setup'] = function(block) {
  Blockly.Python.definitions_['from_machine_import_pin'] = 'from machine import Pin';
  Blockly.Python.definitions_['from_sled_import_neopixel'] = 'from neopixel import NeoPixel';

  var code = `np = NeoPixel(Pin(12, Pin.OUT), 3); np.bright = 50\n`;
  return code;
};

Blockly.Python.forBlock['sled_set_color1'] = function(block) {
...
Blockly.Python.forBlock['sled_set_color2'] = function(block) {
  var value_n = Blockly.Python.valueToCode(block, 'n', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['sled_fill_color1'] = function(block) {
  var colour_color = block.getFieldValue('color');
...
Blockly.Python.forBlock['sled_fill_color2'] = function(block) {
  var value_red = Blockly.Python.valueToCode(block, 'red', Blockly.Python.ORDER_ATOMIC);
  var value_green = Blockly.Python.valueToCode(block, 'green', Blockly.Python.ORDER_ATOMIC);
  var value_blue = Blockly.Python.valueToCode(block, 'blue', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['sled_show'] = function(block) {
  var code = 'np.write()\n';
  return code;
};

Blockly.Python.forBlock['sled_clear'] = function(block) {
  var code = 'for i in range(np.n): np[i] = (0, 0, 0)\n';
  return code;
};

Blockly.Python.forBlock['sled_rainbow'] = function(block) {
...
Blockly.Python.forBlock['sled_set_brightness'] = function(block) {
