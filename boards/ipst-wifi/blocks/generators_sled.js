Blockly.Python['sled_setup'] = function(block) {
...
Blockly.Python['sled_set_color1'] = function(block) {
...
Blockly.Python['sled_set_color2'] = function(block) {
  var value_n = Blockly.Python.valueToCode(block, 'n', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['sled_fill_color1'] = function(block) {
  var colour_color = block.getFieldValue('color');
...
Blockly.Python['sled_fill_color2'] = function(block) {
  var value_red = Blockly.Python.valueToCode(block, 'red', Blockly.Python.ORDER_ATOMIC);
  var value_green = Blockly.Python.valueToCode(block, 'green', Blockly.Python.ORDER_ATOMIC);
  var value_blue = Blockly.Python.valueToCode(block, 'blue', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python['sled_show'] = function(block) {
  var code = 'np.write()\n';
  return code;
};

Blockly.Python['sled_clear'] = function(block) {
  var code = 'for i in range(np.n): np[i] = (0, 0, 0)\n';
  return code;
};

Blockly.Python['sled_rainbow'] = function(block) {
...
Blockly.Python['sled_set_brightness'] = function(block) {
