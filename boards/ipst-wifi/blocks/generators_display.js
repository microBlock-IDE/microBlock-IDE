Blockly.Python['display_draw_text'] = function(block) {
  ...
  var code = `display.text(str(${value_text}), ${value_x}, ${value_y}, 1); display.show()\n`;
  return code;
};
...
Blockly.Python['display_draw_line'] = function(block) {
  ...
  var code = `display.line(${value_x1}, ${value_y1}, ${value_x2}, ${value_y2}, 1); display.show()\n`;
  return code;
};
...
Blockly.Python['display_draw_rect'] = function(block) {
  ...
  var code = `display.${(+dropdown_fill) ? 'fill_rect' : 'rect'}(${value_x}, ${value_y}, ${value_width}, ${value_height}, 1); display.show()\n`;
  return code;
};

Blockly.Python['display_fill'] = function(block) {
  var code = 'display.fill(1); display.show()\n';
  return code;
};

Blockly.Python['display_clear'] = function(block) {
  var code = 'display.fill(0); display.show()\n';
  return code;
};
