            ...
            blocks: [
                ...
                },
                {
                    ...
                    blocks: [
                        ...
                        {
                            xml: '<label text="SLED"></label>',
                        },
                        "sled_setup",
                        {
                            xml: `
                                <block type="sled_set_color1">
                                    <value name="n">
                                        <shadow type="math_number">
                                            <field name="NUM">0</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="sled_set_brightness">
