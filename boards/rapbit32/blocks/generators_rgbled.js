Blockly.Python.forBlock['rgbled_setup'] = function(block) {
...
Blockly.Python.forBlock['rgbled_set_color1'] = function(block) {
...
Blockly.Python.forBlock['rgbled_set_color2'] = function(block) {
  var value_n = Blockly.Python.valueToCode(block, 'n', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['rgbled_fill_color1'] = function(block) {
  var colour_color = block.getFieldValue('color');
...
Blockly.Python.forBlock['rgbled_fill_color2'] = function(block) {
  var value_red = Blockly.Python.valueToCode(block, 'red', Blockly.Python.ORDER_ATOMIC);
  var value_green = Blockly.Python.valueToCode(block, 'green', Blockly.Python.ORDER_ATOMIC);
  var value_blue = Blockly.Python.valueToCode(block, 'blue', Blockly.Python.ORDER_ATOMIC);
