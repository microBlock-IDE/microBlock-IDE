            ...
            blocks: [
                ...
                },
                {
                    ...
                    blocks: [
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_wheel">
                                    <value name="speed_m1">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        "motor_stop_mecanum",
                        {
                            xml: '<label text="Move 2 wheel"></label>',
                        },
                        {
                            xml: `
                        ...
                        {
                            xml: '<label text="Move Mecanum (4 wheel)"></label>',
                        },
                        {
                            xml: `
                                <block type="motor_mecanum_forward">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_backward">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_turn_left">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_turn_right">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_spin_left">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_spin_right">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_slide_left">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_slide_right">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_diagonal_left">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
                        ...
                        {
                            xml: `
                                <block type="motor_mecanum_diagonal_right">
                                    <value name="speed">
                                        <shadow type="math_number">
                                            <field name="NUM">50</field>
                                        </shadow>
